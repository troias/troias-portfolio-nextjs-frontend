                ...
                <nav className="flex items-center justify-between flex-wrap bg-gray-800 p-6 max-w-screen-lg w-full">
                    ...
                    <div className={"hidden w-full block flex-grow lg:flex lg:items-center lg:w-auto "} >
                        <div className="text-sm lg:flex-grow">
                            <a href="/" className="block mt-4 lg:inline-block lg:mt-0 hover:text-teal-200 text-white mr-4">
                                Home
                            </a>
                            <a href="/projects" className="block mt-4 lg:inline-block lg:mt-0 hover:text-teal-200 text-white mr-4">
                                Projects
                            </a>
                            <a href="/skills" className="block mt-4 lg:inline-block lg:mt-0 hover:text-teal-200 text-white mr-4">
                                Skills
                            </a>
                            <a href="/#contact" className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-teal-200 mr-4">
                            Contact
                        </a> 
                        </div>
                        <div>
                            <a href="#" className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0">Download CV</a>
                        </div>
                    </div>
                </nav>
