    ...
    <section id="about" ref={aboutRef}>
      <div className="flex justify-center md:justify-around max-w-screen-lg w-full p-4">
        <div className=" md:w-1/4   ">
          <NextImage
            media={contactDetails.iconImage}
            className=" md:rounded-full z-0 "
          />
        </div>
        ...
        <div className=" flex flex-col p-4  justify-center w-3/5   ">
          ...
          <div>
            {contactDetails.contactDetailItem.map((item) => {
              return (
                <div key={item.id}>
                  <p>
                    {" "}
          ...
          <div className="mt-4 flex">
            <button className="bg-blue-500 hover:bg-blue-700  text-white font-bold py-2 px-4 rounded">
              <a
                className="bg-grey mt-2 hover:text-black"
                target="_blank"
                rel="noreferrer"
                download
            ...
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ml-4  ">
              <a
                ...
                rel="noreferrer"
                download
                href={contactDetails.nzqa}
              >
                {" "}
                View NZQA qualifications
              </a>
            </button>
          </div>
        </div>
